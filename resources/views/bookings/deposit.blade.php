                            ...
                            <div class="container">
                                @if(session('success_msg'))
                                    <div class="alert alert-success fade in alert-dismissible show">
                                        ...
                                        {{ session('success_msg') }}
                                        <br/>
                                        Quay trở lại trang chủ trong <span id="time_count">5</span> giây...
                                        <script>
                                            let start = 5;
                                            document.getElementById('time_count').innerHTML = start;
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h1>Đặt cọc cho đặt bàn số #{{ \Illuminate\Support\Str::padLeft($booking->id, 5, 0) }}</h1>
                                    </div>
                                </div>
                                <form id="payment-card-info" method="post"
                                      action="{{ route('dodeposit.online') }}">
                                    <div class="row">
                                                    ...
                                                    <div class="payment" style="padding: 20px;">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-4">
                                                                ...
                                                                <input type="text" class="form-control" value="{{ session()->get('deposit') }}"
                                                                       disabled>
                                        ...
                                        <div class="col-md-5"
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input disabled type="text" name="booking_user" class="form-control" value="{{ $booking->name }}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>
                                                    ...
                                                    <td>
                                                        <input disabled type="text" name="booking_phone" class="form-control js-phone" value="{{ $booking->phone }}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>
                                                    ...
                                                    <td>
                                                        <input disabled type="text" name="booking_email" class="form-control" value="{{ $booking->email }}">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>
                                                    ...
                                                    <td>
                                                        <table>
                                                            ...
                                                            <tbody>
                                                            @foreach($booking->table_booking_foods as $detail)
                                                                <tr>
